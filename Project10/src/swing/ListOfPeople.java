...
public class ListOfPeople extends JFrame implements ActionListener{
	...
	public ListOfPeople( String namefile) {
		...
		bAdd.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		panel.add(bAdd);
		bAdd.requestFocus();
		bAdd.addActionListener(this);
		
		bDelete = new JButton("DELETE");
		bDelete.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		panel.add(bDelete);
		bDelete.addActionListener(this);
		
		bFind = new JButton("FIND");
		bFind.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		panel.add(bFind);
		bFind.addActionListener(this);
		
		bEdit = new JButton("EDIT");
		bEdit.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		panel.add(bEdit);
		bEdit.addActionListener(this);
		
		bSort = new JButton("SORT");
		bSort.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		panel.add(bSort);
